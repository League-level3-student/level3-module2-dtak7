...
public class _01_SearchingAndSortingAlgorithms {
	 ...
	 * 
	 * @Test public void testSortStringLength() throws Exception { List<String>
	 * unsortedSequences = Arrays.asList(new String[] {
	 * "ATAGCTGATCGTAGCTACGTACGATCG", "CATCGTACATGC", "TATGTGT",
	 * "GCTGATCGTGACTGTAC", "ACTGT" }); List<String> sortedSequences =
	 * Arrays.asList(new String[] { "ACTGT","TATGTGT", "CATCGTACATGC",
